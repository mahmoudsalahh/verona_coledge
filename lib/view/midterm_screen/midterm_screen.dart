...
import '../../view_model/shared/Exams_cubit/exams_states.dart';
...
//Widget indecator()=> Center(child: CircularProgressIndicator());
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<ExamsCubit,ExamsStates>(
      ...
      builder: (context,state){
        ...
        return Scaffold(
          ...
          body: ConditionalBuilder(
            condition: state is GetExamsDataSuccessState,
            builder: (context)=> Padding(
              padding:  EdgeInsets.all(20.0),
              child: ListView.separated(
                physics: BouncingScrollPhysics(),
                itemBuilder: (context, index) =>midtermData(ExamsCubit.get(context).isMidterm[index]),
                itemCount:ExamsCubit.get(context).isMidterm.length,
  ...
  Widget midtermData( MidData  model){
    return Padding(
